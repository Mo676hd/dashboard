    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <Card>
          ...
          <CardContent>
            <p className="text-lg font-semibold">{mockCase.customerName}</p>
            <p className="text-sm text-gray-600">{mockCase.contact}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-lg font-semibold">{mockCase.carMakeModel}</p>
            <p className="text-sm text-gray-600">{mockCase.color} • {mockCase.plateNumber}</p>
          </CardContent>
        </Card>
      ...
      <Tabs defaultValue="images" className="space-y-4">
        ...
        <TabsContent value="status">
          <Card>
            <CardHeader>
              <CardTitle>Case Status Timeline</CardTitle>
            </CardHeader>
            <CardContent>
